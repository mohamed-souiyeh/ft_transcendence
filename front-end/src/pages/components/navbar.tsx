      ...
      <div className="absolute top-0 right-0 flex gap-1">
        ...
        <div className=" mx-auto h-12 bg-purple-sh-1 rounded-full grid place-content-center overflow-hidden ">
          <form action='' className="relative mx-auto w-max">
            <input type='search' className='w-12 h-12 bg-transparent focus:cursor-text cursor-pointer border-transparent outline-none text-transparent focus:text-impure-white relative z-10 focus:w-48 pr-8 focus:pl-4' />
